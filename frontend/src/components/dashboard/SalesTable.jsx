...
const SalesTable = () => {
  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-white/[0.05] bg-white dark:bg-white/[0.03] transition-colors">
      <div className="max-w-full max-h-[700px] overflow-x-auto overflow-y-auto">
        <Table>
